...
% experiment 1
experiment1='icub-insitu-ft-analysis-big-datasets/2016_07_05/gridMin45';
...
% ftDataNoOffset3=removeOffset(reCalibData3,e1.dataset.estimatedFtData.(ftNames{i}));
   ...
   figure,plot3_matrix(ftDataNoOffset1(:,1:3));hold on;
    plot3_matrix(e1.dataset.estimatedFtData.(ftNames{4})(:,1:3)); grid on;
...
zlabel('F_{z}');
     ...
     figure,
      plot3_matrix(e1.dataset.estimatedFtData.(ftNames{4})(:,1:3)); grid on;  hold on; 
...
%error calculation
    ...
    dif1=e1.dataset.estimatedFtData.(ftNames{4})(:,1:3)-ftDataNoOffset1(:,1:3);
     dif2=e1.dataset.estimatedFtData.(ftNames{4})(:,1:3)-ftDataNoOffset2(:,1:3);
      dif3=e1.dataset.estimatedFtData.(ftNames{4})(:,1:3)-ftDataNoOffset3(:,1:3);
