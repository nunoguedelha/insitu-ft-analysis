...
for ftIdx =1:length(sensorsToAnalize)
    ...
    error.(ft)(n,:)=masses-masses_estimated;
    error_noGravity.(ft)(n,:)=masses_noGravity-masses_estimated;
    
    stdMasses.(ft)(n)=std(masses)
    stdMassesNoG.(ft)(n)=std(masses_noGravity)
end
