...
%% select sensor to calibrate
 sensNum = 'SN242';      % sensor to calibrate
...
%dataPath ='/data/NewScheda/FT45A_mod_gen2017/';
...
fittedEllipsoid_im=ellipsoidfit_smart(B_pred5(:,1:3),acc5);
ref_ellipse= ellipsoidfit_smart(B5(:,1:3),acc5);
% axis equal;
figure, 
% plot_ellipsoid_im(fittedEllipsoid_im); hold on;
% plot_ellipsoid_im(ref_ellipse,'EdgeColor','k'); hold on;
plot3(B_pred5(:,1),B_pred5(:,2),B_pred5(:,3),'*'); hold on;
plot3(B5(:,1),B5(:,2),B5(:,3),'r*');
axis equal;
grid on;
legend('sphere','ref sphere','sensor','reference');


% do some nice plots on the forces
fitted25=ellipsoidfit_smart(B_pred25(:,1:3),acc25);
ref_ellipse25= ellipsoidfit_smart(B25(:,1:3),acc25);
% axis equal;
figure, 
 plot_ellipsoid_im(fitted25); hold on;
 plot_ellipsoid_im(ref_ellipse25,'EdgeColor','k'); hold on;
plot3(B_pred25(:,1),B_pred25(:,2),B_pred25(:,3),'*'); hold on;
plot3(B25(:,1),B25(:,2),B25(:,3),'r*');
axis equal;
grid on;
legend('sphere','ref sphere','sensor','reference');
...
% fittedEllipsoid_im=ellipsoidfit_smart(B_pred5(:,1:3),acc5);
% ref_ellipse= ellipsoidfit_smart(B5(:,1:3),acc5);
% noref=ellipsoidfit_leastsquares(B_pred5(:,1),B_pred5(:,2),B_pred5(:,3));
% % axis equal;
% figure, 
% plot_ellipsoid_im(fittedEllipsoid_im); hold on;
% plot_ellipsoid_im(ref_ellipse,'EdgeColor','k'); hold on;
% plot_ellipsoid_im(noref,'EdgeColor','c'); hold on;
% plot3(B_pred5(:,1),B_pred5(:,2),B_pred5(:,3),'*'); hold on;
% plot3(B5(:,1),B5(:,2),B5(:,3),'r*');
% %grid on;
% legend('sphere','ref sphere','sensor','reference');
